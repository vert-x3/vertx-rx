...
the {@link io.vertx.rxjava3.ext.web.client.HttpRequest#send()} method returns a `Single<HttpResponse<Buffer>>` that
...
The {@link io.vertx.rxjava3.ext.web.client.HttpRequest#sendStream(io.reactivex.rxjava3.core.Flowable)} shall
