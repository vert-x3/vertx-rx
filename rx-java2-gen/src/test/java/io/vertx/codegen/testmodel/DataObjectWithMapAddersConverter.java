 ...
 */
public class DataObjectWithMapAddersConverter implements JsonMapper<DataObjectWithMapAdders, JsonObject> {

  public static final DataObjectWithMapAddersConverter INSTANCE = new DataObjectWithMapAddersConverter();

  @Override public JsonObject serialize(DataObjectWithMapAdders value) { return (value != null) ? value.toJson() : null; }

  @Override public DataObjectWithMapAdders deserialize(JsonObject value) { return (value != null) ? new DataObjectWithMapAdders(value) : null; }
