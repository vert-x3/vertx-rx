 ...
 * === Json unmarshalling
 *
 * The {@link io.vertx.reactivex.FlowableHelper#unmarshaller(java.lang.Class)} creates an `io.reactivex.rxjava2.FlowableOperator` that
 ...
 * ----
 *
 * The {@link io.vertx.reactivex.ObservableHelper#unmarshaller(java.lang.Class)} can be used to parse and map
