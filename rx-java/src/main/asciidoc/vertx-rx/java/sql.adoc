...
Vert.x provides __observable transformers__ that you can apply to your flows with http://reactivex.io/RxJava/1.x/javadoc/rx/Observable.html#compose-rx.Observable.Transformer-[`compose`] to make them transactional:
...
After your got an instance of `io.vertx.rxjava.ext.sql.SQLConnection`, you can use it to perform the SQL operations:
