...
The `link:apidocs/io/vertx/rxjava/core/http/HttpClient.html#websocket-int-java.lang.String-java.lang.String-io.vertx.core.Handler-[websocket]` provides a single callback when the websocket
