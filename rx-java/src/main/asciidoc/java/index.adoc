...
The `link:../../apidocs/io/vertx/rx/java/RxHelper.html#toObservable-io.vertx.core.streams.ReadStream-io.vertx.core.Vertx-[RxHelper.toObservable]` static methods converts
